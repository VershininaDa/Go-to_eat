const productsBtnn = document.querySelectorAll('.product__btn');
	...
	return `
		<li class="cart-content__item">
								<article class="cart-content__product cart-product data-id='${id}'>
									<img src='${img}' alt="картошка" class="cart-product__img">
									<div class="cart-product__text">
										<h3 class="cart-product__title">${title}</h3>
										<span class="cart-product__price">${price}</span>
									</div>
									<button class="cart-product__delite"></button>
								</article>
							</li>
	`;
}
...
cartProductsList.addEventListener('click', (e) => {
	if (e.target.classList.contains('.cart-product__delite')) {
